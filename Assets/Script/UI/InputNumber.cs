...
public class InputNumber : MonoBehaviour
{
    ...
    public void OK()
    {
        ...
        if (text_Input.text != "")
        {
            if (CheckNumber(text_Input.text))
            {
                ...
                if (num > DragSlot.instance.dragSlot.itemCount) num = DragSlot.instance.dragSlot.itemCount;
            }
            else
            {
                num = 1;
    ...
    IEnumerator DropItemCoroutine(int _num)
    {
        ...
        {
            if (QuickSlotController.go_HandItem != null) Destroy(QuickSlotController.go_HandItem);
        }
